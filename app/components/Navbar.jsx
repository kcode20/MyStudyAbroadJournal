        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul className="nav navbar-nav navbar-right">
              <li>
                  {this.props.auth? <a className="navbar-center" href='#'><span className="glyphicon glyphicon-home green" aria-hidden="true"></span></a> : ""}
              </li>
              <li>
                  {this.props.auth? <a className="navbar-center" href='#'><span className="glyphicon glyphicon-comment green" aria-hidden="true"></span></a> : ""}
              </li>
              <li>
                  {this.props.auth? <a className="navbar-center" href='#'><span className="glyphicon glyphicon-globe green" aria-hidden="true"></span></a> : ""}
              </li>
              <li><a href="#">{this.props.auth?  <li className="dropdown">
                                          <span href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src={this.props.auth.photoURL} className='user_nav' width='25px' height='25px'/> <span className="caret"></span></span>
                                          <ul className="dropdown-menu">
                                            ...
                                            <li role="separator" className="divider"></li>
                                            <li><a onClick={()=> this.props.logout().then(()=> browserHistory.push('/login'))} href="#">Logout</a></li>
                                          </ul>
                                        </li>
